...
void setup() {
  ...
  //growlight credentials or defaults
...
void handleRoot() {
  ...
  html += "<label>night duration (hour): <input type='number' style='width: 40px;' name='night_hours' value='" + String(24 - lightHours) + "' readonly></label>";
  html +="</div>";
  html +="</td><td>";
